...
train_dl = DataLoader(training_dataset, constants.BATCH_SIZE, shuffle=True, num_workers=6, pin_memory=True)
val_dl = DataLoader(valid_dataset, constants.BATCH_SIZE, num_workers=6, pin_memory=True)
test_dl = DataLoader(testing_dataset, constants.BATCH_SIZE, num_workers=6, pin_memory=True)
